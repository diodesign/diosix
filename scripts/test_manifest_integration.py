...
def run_integration_test():
    ...
    try:
        ...
        child.expect(r"Diosix Hypervisor Information", timeout=10)
        child.expect(r"Hardware H-Extension", timeout=10)
        ...
        child.expect(r"Diosix Guest VM Info", timeout=10)
        ...
        child.expect(r"Service Resolution:", timeout=10)
